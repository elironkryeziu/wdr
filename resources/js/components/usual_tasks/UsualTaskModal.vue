  ...
  <div class="">
      <div class="float-right">
        ...
        <tabs>
            ...
            <tab name="Daily Task" :selected="$store.state.usual_tasks.type == 'daily' ? true : false">
                <EditDailyTask :id="id"/>
            </tab>
            <tab name="Weekly Task" :selected="$store.state.usual_tasks.type == 'weekly' ? true : false">
                <EditWeeklyTask :id="id"/>
            </tab>
            <tab name="Monthly Task" :selected="$store.state.usual_tasks.type == 'monthly' ? true : false">
                <EditMonthlyTask :id="id"/>
            </tab>
        </tabs>
    <!-- <div class="py-6">
